...
public class StormApp {
    public static void main(String[] args) {
        ...
        builder.setBolt("C_LEVEL1_FIVE_SECOND_BAR_BOLT", new Level1BarFilterBolt2(5)).fieldsGrouping("C_LEVEL1_UPDATE_SPOUT", "S_LEVEL1_UPDATE", new Fields("symbol")).shuffleGrouping("C_TICK_SPOUT","S_TICK");
